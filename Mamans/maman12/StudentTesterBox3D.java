...
public class StudentTesterBox3D {
    ...
    private static void testBox3D() {
        ...
        int volume1 = b1.getVolume();
        int volume2 = b3.getVolume();
        int volume3 = b4.getVolume();
        ...
        int surfaceArea1 = b1.getSurfaceArea();
        int surfaceArea2 = b3.getSurfaceArea();
        int surfaceArea3 = b4.getSurfaceArea();
